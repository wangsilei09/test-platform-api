...
-- Records of api_info
-- ----------------------------
INSERT INTO `api_info` VALUES (1, '获取接口列表', 581, 34, NULL, '', NULL, 3, 'https://xiaobaicodes.com:8888/api/apiInfo/list', 'POST', '[]', NULL, '[]', '[]', '[]', '{\"url\": \"https://xiaobaicodes.com:8888/api/apiInfo/list\", \"data\": \"{}\", \"mode\": \"raw\", \"method\": \"POST\", \"params\": {}, \"upload\": {}, \"verify\": false, \"cookies\": {}, \"headers\": [{\"key\": \"Content-Type\", \"value\": \"application/json\", \"remarks\": \"\"}], \"timeout\": 120, \"language\": \"JSON\", \"req_json\": null, \"allow_redirects\": true}', '[]', '[]', '', NULL, NULL, '2024-05-30 21:05:46', '2024-05-30 21:05:46', 7, 7, 1, '148f069e8e5e4e9ea5f95edf076ddeab', 'api', '[]', '[]', '', '');
...
INSERT INTO `menu` VALUES (79, 63, '/storyInfo', 'storyInfo', '/api/story/index.vue', '功能管理', 0, '', 0, 'ele-Files', 1, 0, 0, '0', 0, NULL, 10, '', '2024-05-30 14:51:37', '2024-06-04 16:14:40', 1, 0, 7, 7, NULL, 'f444522644db491d8b363b3b9880f9eb');
...
CREATE TABLE `module_info`  (
  ...
  `dev_user` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
...
CREATE TABLE `story_info`  (
  ...
  `updated_by` int(11) NULL DEFAULT NULL,
  `trace_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'trace_id',
  `test_user` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `dev_user` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `user` VALUES ('2024-06-04 16:18:29', '2024-06-04 16:18:36', 1, 14, 'test', '123456', '', '[3]', 'test', 1, 13, 13, 20, '', NULL, 'null', 'ff253bd121304e7da9ec723cc36017e6');
