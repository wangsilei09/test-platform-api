...
class ModuleInfo(Base):
    ...
    config_id = mapped_column(Integer, comment='关联配置id')
    test_user = mapped_column(String(255), comment='测试负责人')
    dev_user = mapped_column(String(255), comment='测试负责人')
    simple_desc = mapped_column(String(255), comment='简要描述')
    remarks = mapped_column(String(255), comment='其他信息')
    module_packages = mapped_column(String(64), comment='模块对应的包名称')
    leader_user = mapped_column(String(255), comment='负责人')
